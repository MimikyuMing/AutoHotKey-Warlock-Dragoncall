class GCDManager {
    ...
    static SKILL_GCD_TIMES := Map(
        "Dragoncall_Instant", 100,    ; 暴魔灵瞬发 (原450)
        "Wingstorm_Instant", 100,     ; 死灵突袭瞬发 (原450)
        "Mantra", 500,                ; 真言 (原700)
        "Rupture", 300,               ; 破裂 (原500)
        "Bombardment_True", 100,      ; 真次元弹 (原350)
        "Bombardment_Instant", 100,   ; 次元弹瞬发 (原350)
        "Bombardment_Normal", 100,    ; 次元弹非瞬发 (原850)
        "Leech", 200,                  ; 掠夺 (原500)
        "R", 200
    )
