...
class StateManager {
    ...
    static Init(captureClientObj) {
        ...
        this._coldDownState := RealtimeMap(captureClientObj.RealtimeMode)
        ...
        ; 为 _coldDownState 配置实时查询参数
        this._coldDownState.type := "coldDown"
        this._coldDownState.idxMap := captureClientObj.coldDownIdx
    ...
    static GetColdDownState() => this._coldDownState
